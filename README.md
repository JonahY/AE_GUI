...
<div align=center>
<img src="/MD_figs/软件架构图.png" width="500px">
</div>  
## 软件功能描述
### 软件激活
...
功能流程图如下图所示：  
<div align=center>
<img src="/MD_figs/软件激活功能流程图.png" width="500px">
</div>  
初次运行软件时激活窗口如下所示:  
<div align=center>
<img src="/MD_figs/active_1.png" width="500px">
</div>  
激活成功窗口如下所示：  
<div align=center>
<img src="/MD_figs/active_2.png" width="500px">
</div>  
License过期窗口如下所示：  
<div align=center>
<img src="/MD_figs/active_3.png" width="500px">
</div>  
### License更新
成功激活软件进入Visualization界面后，可以选择更新License信息。其中，只有当根据新导入License文件计算出的激活期限长于当前License文件的激活期限时，才允许更新此凭证。  
功能流程图如下图所示：  
<div align=center>
<img src="/MD_figs/License更新功能流程图.png" width="500px">
</div>  
新导入的License期限短于当前License时的窗口如下所示：  
<div align=center>
<img src="/MD_figs/updateLicense_1.png" width="500px">
</div>  
新导入的License期限长于当前License时的窗口如下所示：  
<div align=center>
<img src="/MD_figs/updateLicense_2.png" width="500px">
</div>  
### 设备切换与数据导入
...
功能流程图如下图所示：  
<div align=center>
<img src="/MD_figs/设备切换与数据导入功能流程图.png" width="500px">
</div>  
Vallen设备数据载入模式窗口如下所示：  
<div align=center>
<img src="/MD_figs/LoadData_1.png" width="500px">
</div>  
PAC设备数据载入模式（无覆盖）窗口如下所示：  
<div align=center>
<img src="/MD_figs/LoadData_2.png" width="500px">
</div>  
PAC设备数据载入模式（覆盖）窗口如下所示：  
<div align=center>
<img src="/MD_figs/LoadData_3.png" width="500px">
</div>  
### 波形分析
...
功能流程图如下图所示：  
<div align=center>
<img src="/MD_figs/波形分析功能流程图.png" width="500px">
</div>  
可视化成功窗口如下所示：  
<div align=center>
<img src="/MD_figs/waveform_1.png" width="500px">
</div>  
可视化时提示报错窗口如下所示：  
<div align=center>
<img src="/MD_figs/waveform_2.png" width="500px">
</div>  
### 数据筛选
...
功能流程图如下图所示：  
<div align=center>
<img src="/MD_figs/数据筛选功能流程图.png" width="500px">
</div>  
筛选成功窗口如下所示：  
<div align=center>
<img src="/MD_figs/filter_1.png" width="500px">
</div>  
重置筛选窗口如下所示：  
<div align=center>
<img src="/MD_figs/filter_2.png" width="500px">
</div>  
筛选提示警告窗口如下所示：  
<div align=center>
<img src="/MD_figs/filter_3.png" width="500px">
</div>  
### 特征分析
...
功能流程图如下图所示：  
<div align=center>
<img src="/MD_figs/特征分析功能流程图.png" width="500px">
</div>  
概率密度分布统计分析（不拟合数据）窗口如下所示：  
<div align=center>
<img src="/MD_figs/statistics_1.png" width="500px">
</div>  
概率密度分布统计分析（拟合数据）窗口如下所示：  
<div align=center>
<img src="/MD_figs/statistics_2.png" width="500px">
</div>  
### 万能试验机数据载入
在进行特征分析时，支持导入万能试验机的应力应变数据，便于结合声发射结果进行分析。此外，支持对应力曲线进行平滑。  
功能流程图如下图所示：  
<div align=center>
<img src="/MD_figs/万能试验机数据载入功能流程图.png" width="500px">
</div>  
特征时域分析（未导入应力应变数据）窗口如下所示：  
<div align=center>
<img src="/MD_figs/stretcher_1.png" width="500px">
</div>  
特征时域分析（导入应力应变数据）窗口如下所示：  
<div align=center>
<img src="/MD_figs/stretcher_2.png" width="500px">
</div>  
特征时域分析（导入应力应变数据，平滑处理）窗口如下所示：  
<div align=center>
<img src="/MD_figs/stretcher_3.png" width="500px">
</div>  
## 操作流程
本软件的操作流程如图所示：  
<div align=center>
<img src="/MD_figs/操作流程图.png" width="500px">
</div>  
## 安装与维护
### 安装
